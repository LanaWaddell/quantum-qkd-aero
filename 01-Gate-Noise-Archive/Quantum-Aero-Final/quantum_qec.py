...
# --- Noise Model ---
# 1% bit-flip error probability (Lowered from 10% for threshold test)
p_error = 0.01
...
print("\n--- Final QEC Repetition Code Test (1% Noise) ---")
print(f"Simulation with {p_error*100}% Bit-Flip error (Low-Interference Threshold Test)")
...
print("\nInterpretation:")
print("- At 1% noise, the overhead of QEC gates is lower than the gain from error correction.")
print("- EXPECTED: '01' and '10' error rates should be near-zero (< 1%).")
